export const login = (email?: string) => `<!DOCTYPE html>
  <html>
    <head>
      <meta charset="utf-8">
    ...
    <body>
      ...
      <div class="login-card">
        ...
        <p class="email-intro">Sign in with email</p>
        <form method="post" class="email-form">
          <input name="email" type="email" class="email-input" placeholder="your@email.com">
          <button class="email-button" type="submit">Continue</button>
        </form>
        `
        }
